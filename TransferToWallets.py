...
sleep(3)
print("\nDistribute the Dark Army's funds among all individuals with bank accounts in both NYC and Scranton.")
sleep(2)
...
while True:
    ...
    sleep(2)
    if bank_account == 'y':
        print("You are eligible to claim a portion of the Dark Army's funds.")
        sleep(2)
        print("You will be awarded a random amount ranging from $0 to $12,000,000.00.")
        sleep(2)
        ...
        random_value = random.uniform(1, 12_000_000)
